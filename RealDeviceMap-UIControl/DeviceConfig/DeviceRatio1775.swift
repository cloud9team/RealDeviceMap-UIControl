...
class DeviceRatio1775: DeviceConfigProtocol {
    ...
    var logoutDragEnd2: DeviceCoordinate {
        return DeviceCoordinate(x: 550, y: 750, scaler: scaler)
    }
    ...
    var loginNewPlayer: DeviceCoordinate {
        return DeviceCoordinate(x: 320, y: 790, scaler: scaler)
    }
    ...
    var loginBanned: DeviceCoordinate {
        return DeviceCoordinate(x: 178, y: 570, scaler: scaler)
    }
    ...
    var adventureSyncButton: DeviceCoordinate {
        return DeviceCoordinate(x: 320, y: 982, scaler: scaler)
    }
